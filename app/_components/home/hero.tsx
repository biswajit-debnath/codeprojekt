...
const Hero = () => {
  ...
  return (
    <div className="relative px-5 md:px-10 lg:px-20 pt-2 md:pt-5 font-['The-Last-Shuriken']">
      <motion.div
        className="relative h-[200px] md:h-[300px] lg:h-[400px] max-w-[1550px] mx-auto"
        initial="hidden"
        animate="show"
      ...
      >
        ...
        <motion.div
          className="absolute bottom-10 lg:bottom-20 inset-x-0 flex flex-col items-center z-20"
          variants={slideIn("up", 0.5)}
          initial="hidden"
          animate="show"
        >
          <motion.h1
            className="text-xl md:text-5xl lg:text-6xl font-bold text-white mb-4 md:mb-8 text-center"
          ...
          >
            <Link href="/diamond-packs">
              <button className={`text-white transition-colors px-8 lg:px-20 py-2 md:py-3 lg:pt-5 lg:pb-4 md:text-xl lg:text-3xl ${styles['custom-button']}`}>
                BUY DIAMONDS
              </button>
            </Link>
          </motion.div>
